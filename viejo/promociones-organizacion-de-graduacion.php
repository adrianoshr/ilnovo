...
<html lang="eng">  
	<title>Promociones - Mi Graduación | Il Novo Catering Organización de eventos</title>
		<meta charset="utf-8">
		...
		<div class="content-wrapper">
			...
			<div class="content inner-page">
				...
				<div class="inner-header">
					...
					<!--  THE PAGE TITLE -->
					<div class="fl-left"><h1>Promociones | Mi Graduación</h1></div><!-- /.fl-left -->

					<!--  THE PAGE BREADCRUMBS -->
					<div class="fl-right"><p id="breadcrumbs"><a href="index.php">Inicio</a> &nbps; Promociones - Mi Graduación</p></div><!-- /.fl-right -->
				</div> <!-- /.inner-header-->
				...
				<div class="fl-left content-col">
					...
					<div class="single">
						...
						<div class="fl-right">
							<div class="meta">
								<h2>Un momento importante con todo el estilo</h2>
							</div><!-- /.meta -->
						</div><!-- /.fl-right -->
