...
<html lang="eng">  
	<title>Promociones - Mi Boda en la Playa | Organización de bodas y eventos</title>
		<meta charset="utf-8">
		...
		<div class="content-wrapper">
			...
			<div class="content inner-page">
				...
				<div class="inner-header">
					...
					<!--  THE PAGE TITLE -->
					<div class="fl-left"><h1>Promociones | Mi boda en la playa</h1></div><!-- /.fl-left -->

					<!--  THE PAGE BREADCRUMBS -->
					<div class="fl-right"><p id="breadcrumbs"><a href="index.php">Inicio</a> &nbps; Promociones - Mi Boda en la playa</p></div><!-- /.fl-right -->
				</div> <!-- /.inner-header-->
				...
				<div class="fl-left content-col">
					...
					<div class="single">
						...
						<div class="fl-right">
							<div class="meta">
								<h2>Nada como un evento romántico en la playa</h2>
							</div><!-- /.meta -->
						</div><!-- /.fl-right -->
