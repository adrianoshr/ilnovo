...
$secureSecret = "21C73675491B870ABE35845E2534AC45";
...
?> <!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN'>
    ...
    <center>
    <h1>Respuesta de <?php echo($title); ?> <?php echo($error); ?></H1></center>
    
    <table width="85%" align='center' cellpadding='5' border='0'>
     <tr>                  
            <td align='right'><strong><i>Informacion de la Orden: </i></strong></td>
            <td><?php echo($orderInfo); ?></td>
        </tr>
        <tr class='shade'>
            <td align='right'><strong><i>Total de la Transaccion: </i></strong></td>
            <td>$ <?php echo($amount); ?> pesos</td>
        </tr>
    <tr>
            <td width="50%" align='right'><strong><i>&nbsp;C&oacute;digo de Descripci&oacute;n de la Transacci&oacute;n: </i></strong></td>
            <td width="50%"><?php echo($txnResponseCodeDesc); ?></td>
        </tr>
        <tr class='shade'>                  
            <td align='right'><strong><i>Mensaje: </i></strong></td>
