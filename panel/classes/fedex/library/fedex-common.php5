...
function getProperty($var){
	if($var == 'key') Return 'LTWUOoMD1DhzGmDV'; 
	//if($var == 'password') Return '9mkCekJxFabID3bxiIYCdwYWa'; 
	if($var == 'password') Return 'SEvCAAv2sElyzk0gvm3gGqvZ5'; 
		
	if($var == 'shipaccount') Return '571274728'; 
	if($var == 'billaccount') Return '571274728'; 
	if($var == 'dutyaccount') Return '571274728'; 
	if($var == 'freightaccount') Return '571274728';  
	if($var == 'trackaccount') Return '571274728'; 

	if($var == 'meter') Return '107033469'; 
