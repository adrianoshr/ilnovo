...
function addShipper(){
	$shipper = array(
		'Contact' => array(
			'PersonName' => 'Marcos Velazquez',
			'CompanyName' => 'NAN Laboratorios',
			'PhoneNumber' => '7777851515'
		),
		'Address' => array(
			'StreetLines' => array('San Pedro #15'),
			'City' => 'Monterrey',
...
function addRecipient(){
	$recipient = array(
		'Contact' => array(
			'PersonName' => 'Alejandro Romero',
			'CompanyName' => 'Comercial Mexicana',
			'PhoneNumber' => '7777889151'
		),
		'Address' => array(
			'StreetLines' => array('Av. Morelos #14 Centro'),
			'City' => 'Cuernavaca',
