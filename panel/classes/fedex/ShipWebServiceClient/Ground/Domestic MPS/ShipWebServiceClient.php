...
$path_to_wsdl = "../../../wsdl/ShipService_v13.wsdl";
...
$masterRequest['TransactionDetail'] = array('CustomerTransactionId' => '*** Ground Domestic MPS Shipping Request v13 - Master using PHP ***');
...
try {
	...
	if ($masterResponse->HighestSeverity != 'FAILURE' && $masterResponse->HighestSeverity != 'ERROR'){
	    ...
	    $childRequest['TransactionDetail'] = array('CustomerTransactionId' => '*** Ground Domestic MPS Shipping Request v13 - Child using PHP ***');
