...
<!--                                        <li class=""><a class="glyphicons edit" href="#images" data-toggle="tab"><i>
                                ...
                                <div class="widget-body">
                                    <form class="form-horizontal" style="margin: 0;" name="editArticle"
                                          id='editArticle' method="get" action="">
                                        <div class="tab-content" style="padding: 0;">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="hidden" id="de" name="de" value="info@promoarticulos.com.mx">
                                                                <input type="hidden" id="fromail" name="fromail" value="info@promoarticulos.com.mx">
                                                                ...
                                                                <span style="margin: 0;"
                                                                      ...
                                                                      data-toggle="tooltip" data-placement="top" data-original-title="First name is mandatory"><i></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <input type="email" value="" class="span8" id="correo"
                                                                       name="correo" title="Indique un email especifico"
                                                                       placeholder="Indique un email especifico"/>
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <select class="span3" id='estado' name='estado'>
                                                                    <option value='1'
                                                                        ...
                                                                        Activo</option>
                                                                    <option value='2'
                                                                            <?= (2 == $idStatus ) ? 'selected' : ''; ?>>Inactivo</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="control-group row-fluid">
                                                    ...
                                                    <div class="controls">
                                                        <textarea  name="contenido" id="contenido"
                                                                   required class="span12" rows="8"></textarea>
                                                    </div>
                                                </div>
                                                <div class="separator line bottom"></div>
                                            </div>
                                            ...
                                            <div class="form-actions" style="margin: 0;">
                                                ...
                                                <button type="button" class="btn btn-icon btn-default glyphicons circle_remove"
                                                        onClick="window.location = 'a004_1_ListadoNewsletter.php';"><i></i>Cancelar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
            ...
            <script> var primaryColor = '#e25f39', dangerColor = '#bd362f', successColor = '#609450', warningColor = '#ab7a4b', inverseColor = '#45484d';
            </script>
            <script>
