            ...
            <div id='wrap'>
                <div id="page-heading">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#"><i class="<?= $rwModulo['imagen'] ?>"></i> Accesos y Privilegios</a></li>
                        <li class="active">Listado de Perfiles</li>
                    </ol>
                    <h1><i class="<?= $rwModulo['imagen'] ?>"></i> Perfiles</h1>
                    <div class="options">
                        <div class="btn-toolbar">
                            <a href="g010_edicion_catalogo.php?nombre_tabla=cfperfiles" class="btn btn-primary"><i class="fa fa-plus-circle"></i>
                                Añadir Nuevo
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-sky">
                                <div class="panel-heading">
                                    <h4>Seleccione un perfil para editar sus permisos.</h4>
                                </div>
                                                ...
                                                $fechaefectiva, $estatus, $caracteristica) = $rsCatalogos->FetchRow()) {
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center" nowrap>
                                                            <a href="g006_edicion_acceso.php?idcf=<?= $idcf ?>"
