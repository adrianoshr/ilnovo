                        ...
                        <div class="left23">
                            <div class="form_content">
                                ...
                                <form id="form1" method="post" action="">
                                    ...
                                    <div class="form_rsvp">
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Boda" class="form_checkbox" value="si">
                                            </div> <span class="checkbox_boda">Boda</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Banquete" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_banquete">Banquete</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Empresarial" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_empresarial">Empresarial</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Social" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_social">Social</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Graduacion" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_graduacion">Graducación</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Quince_años" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_quinceanios">Quince Años</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Fin_de_año" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_findeanio">Fin de año</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="checkbox" name="Coffe_Break" class="form_checkbox" value="si">
                                            </div>
                                            <span class="checkbox_coffeebreak">Coffee Brake</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form_rsvp">
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container"><input type="radio" class="form_radio" name="Lugar_evento" value="si" /></div> <span class="checkbox_si">Si</span>
                                        </div>
                                        <div class="form_row_rsvp">
                                            <div class="checkbox_container">
                                                <input type="radio" class="form_radio" name="Lugar_evento" value="no">
                                            </div> <span class="checkbox_no">No</span>
                                        </div>
                                    </div>
                                    <h3 class="form_subtitle">Detalles del evento</h3>                                                                                      <div class="form">
                                        ...
                                        <div class="form_row">
                                            ...
                                            <textarea class="form_textarea" name="comemtarios" value="details"></textarea>
                                        </div>
                                        <div class="form_row">
